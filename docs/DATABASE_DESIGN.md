...
| `due_day` | INTEGER | NOT NULL | Ngày đến hạn thanh toán trong tháng (1–28) |
...
> **Soft-update:** Hiện tại hệ thống **CHƯA hỗ trợ** cập nhật payment. Tính năng update/delete payment (cho phép sửa note và payment_date) được lên kế hoạch trong phiên bản tương lai. Để sửa payment, hiện tại phải xóa và tạo mới.
