...
| `expense` | DECIMAL(15,2) | nullable, default 0 | Chi tiêu cố định hàng tháng |
...
> **Soft-update:** chỉ cho phép sửa note và payment_date. Các trường tài chính (amount, principal_paid, interest_paid) không thể thay đổi sau khi tạo.
